---
uid: DevExpress.ExpressApp.Security.IsGrantedExtensions.CanWrite``1(DevExpress.ExpressApp.Security.IRequestSecurityStrategy,DevExpress.ExpressApp.IObjectSpace,System.Object,System.String)
name: CanWrite<T>(IRequestSecurityStrategy, IObjectSpace, Object, String)
type: Method
...
syntax:
  content: public static bool CanWrite<T>(this IRequestSecurityStrategy security, IObjectSpace objectSpace, object targetObjectKey, string memberName = null)
  parameters:
  - id: security
...
public class CheckWritePermissionController : ObjectViewController<ListView, Contact> {
    ...
    private void View_CurrentObjectChanged(object sender, EventArgs e) {
        ...
        if (department != null) {
            ...
            if (!securityStrategy.CanWrite<Department>(ObjectSpace, key, nameof(Department.Office))) {
                // ...
            }
        }
    }
