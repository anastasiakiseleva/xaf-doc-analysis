---
uid: DevExpress.Persistent.Validation.RuleCriteriaProperties
name: RuleCriteriaProperties
type: Class
summary: Represent the **RuleCriteria** [Validation Rules](xref:113008)' properties exported to the [Application Model](xref:112580).
syntax:
  content: |-
    [DomainComponent]
    [RulePropertiesIndexed]
    public class RuleCriteriaProperties : RuleBaseProperties, IRuleCriteriaProperties, IRuleCollectionPropertyProperties, IRuleBaseProperties
seealso:
- linkId: DevExpress.Persistent.Validation.RuleCriteriaProperties._members
  altText: RuleCriteriaProperties Members
---
