---
uid: DevExpress.Persistent.Validation.RuleObjectExistsProperties
name: RuleObjectExistsProperties
type: Class
summary: Represent the **RuleObjectExists** [Validation Rules](xref:113008)' properties exported to the [Application Model](xref:112580).
syntax:
  content: |-
    [DomainComponent]
    [RulePropertiesIndexed]
    public class RuleObjectExistsProperties : RuleSearchObjectProperties, IRuleObjectExistsProperties, IRuleSearchObjectProperties, IRuleCollectionPropertyProperties, IRuleBaseProperties
seealso:
- linkId: DevExpress.Persistent.Validation.RuleObjectExistsProperties._members
  altText: RuleObjectExistsProperties Members
---
