---
uid: DevExpress.ExpressApp.Chart.ChartListEditorBase.GetIndexByObject(System.Object)
name: GetIndexByObject(Object)
type: Method
summary: Returns the index of an object that represents the [](xref:DevExpress.ExpressApp.Chart.ChartListEditorBase)'s point.
syntax:
  content: public int GetIndexByObject(object obj)
  parameters:
  - id: obj
    type: System.Object
    description: An object that represents the Charting List Editor's point.
  return:
    type: System.Int32
    description: An index of an object that represents the Charting List Editor's point.
seealso: []
---
