---
uid: DevExpress.ExpressApp.ReportsV2.ReportServiceController.ShowPreview(System.String,DevExpress.Data.Filtering.CriteriaOperator)
name: ShowPreview(String, CriteriaOperator)
type: Method
summary: Displays the Preview Report window.
syntax:
  content: public void ShowPreview(string reportContainerHandle, CriteriaOperator criteria)
  parameters:
