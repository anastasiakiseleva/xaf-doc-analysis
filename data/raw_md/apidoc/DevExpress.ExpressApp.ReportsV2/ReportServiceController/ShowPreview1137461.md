---
uid: DevExpress.ExpressApp.ReportsV2.ReportServiceController.ShowPreview(System.String,DevExpress.Data.Filtering.CriteriaOperator,DevExpress.Xpo.SortProperty[])
name: ShowPreview(String, CriteriaOperator, SortProperty[])
type: Method
summary: Displays the Preview Report window.
syntax:
  content: public void ShowPreview(string reportContainerHandle, CriteriaOperator criteria, SortProperty[] sortProperty)
  parameters:
