---
uid: DevExpress.ExpressApp.ReportsV2.PredefinedReportsUpdater.AddPredefinedReport``1(System.String)
name: AddPredefinedReport<T>(String)
type: Method
...
syntax:
  content: |-
    public void AddPredefinedReport<T>(string displayName)
        where T : XtraReport
  parameters:
  - id: displayName
    type: System.String
