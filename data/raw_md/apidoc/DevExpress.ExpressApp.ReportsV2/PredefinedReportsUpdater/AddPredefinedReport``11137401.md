---
uid: DevExpress.ExpressApp.ReportsV2.PredefinedReportsUpdater.AddPredefinedReport``1(System.String,System.Type,System.Type,System.Boolean)
name: AddPredefinedReport<T>(String, Type, Type, Boolean)
type: Method
...
syntax:
  content: |-
    public void AddPredefinedReport<T>(string displayName, Type dataType, Type parametersObjectType, bool isInplaceReport)
        where T : XtraReport
  parameters:
  - id: displayName
    type: System.String
