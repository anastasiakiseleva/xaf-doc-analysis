---
uid: DevExpress.ExpressApp.ReportsV2.Services.ReportDataSourceHelperBase.SetupBeforePrint(DevExpress.XtraReports.UI.XtraReport,DevExpress.ExpressApp.ReportsV2.ReportParametersObjectBase,DevExpress.Data.Filtering.CriteriaOperator,System.Boolean,DevExpress.Xpo.SortProperty[],System.Boolean)
...
If there is no need to apply criteria, sorting, and pass report parameters, use another overload of the **SetupBeforePrint** method that takes the single _report_ parameter. An example of using this overload is provided in the [How to: Print a Report Without Displaying a Preview](xref:113601) topic.