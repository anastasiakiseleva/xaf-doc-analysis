---
uid: DevExpress.ExpressApp.PivotGrid.PivotGridListEditorBase.PivotGridControl
name: PivotGridControl
type: Property
summary: Provides access to the [](xref:DevExpress.ExpressApp.PivotGrid.PivotGridListEditorBase)'s pivot grid control.
syntax:
  content: public object PivotGridControl { get; }
  parameters: []
  return:
    type: System.Object
    description: An object representing the current List Editor's pivot grid control.
seealso:
- linkId: "113189"
---
