---
uid: DevExpress.ExpressApp.BaseObjectSpace.GetObjects``1(DevExpress.Data.Filtering.CriteriaOperator,System.Collections.Generic.IList{DevExpress.Xpo.SortProperty},System.Boolean)
...
syntax:
  content: public virtual IList<T> GetObjects<T>(CriteriaOperator criteria, IList<SortProperty> sorting, bool inTransaction)
  parameters:
  - id: criteria
  ...
  return:
    ...
    description: Only objects that satisfy the specified criteria will be retrieved to this collection.
seealso: []
---
[!include[CRUD_MethodExampleText](~/templates/crud_methodexampletext111240_1163709.md)]

# [C#](#tab/tabid-csharp)

```csharp
IList activeUsers = objectSpace.GetObjects(
    typeof(ApplicationUser), new BinaryOperator("IsActive", true), true);
```
