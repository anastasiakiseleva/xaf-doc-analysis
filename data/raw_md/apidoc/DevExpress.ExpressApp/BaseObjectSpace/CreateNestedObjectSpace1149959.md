---
uid: DevExpress.ExpressApp.BaseObjectSpace.CreateNestedObjectSpace
name: CreateNestedObjectSpace()
type: Method
summary: Creates a nested Object Space.
syntax:
  content: public virtual IObjectSpace CreateNestedObjectSpace()
  return:
...
The creation of nested Object Spaces is not supported by the Entity Framework because it does not includes facilities like a [nested Units of Work](xref:DevExpress.Xpo.NestedUnitOfWork) in XPO (see [XPObjectSpace.CreateNestedObjectSpace](xref:DevExpress.ExpressApp.Xpo.XPObjectSpace.CreateNestedObjectSpace)).