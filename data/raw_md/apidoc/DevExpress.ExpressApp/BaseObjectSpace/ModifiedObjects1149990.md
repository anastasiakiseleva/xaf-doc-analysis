---
uid: DevExpress.ExpressApp.BaseObjectSpace.ModifiedObjects
name: ModifiedObjects
type: Property
summary: Returns a collection of objects that have been created, modified or deleted in the current object context.
syntax:
  content: public virtual IList ModifiedObjects { get; }
  parameters: []
  return:
