---
uid: DevExpress.ExpressApp.BaseObjectSpace.CreateDataView(System.Type,System.String,DevExpress.Data.Filtering.CriteriaOperator,System.Collections.Generic.IList{DevExpress.Xpo.SortProperty})
...
syntax:
  content: public IList CreateDataView(Type objectType, string expressions, CriteriaOperator criteria, IList<SortProperty> sorting)
  parameters:
  - id: objectType
    type: System.Type
...
seealso: []
---
This method does not return real objects. Instead, it returns a lightweight read-only list of data records that can be viewed much more quickly than a real objects collection.
