...
You can use the following properties to specify the compatibility type individually for each Object Space Provider, for instance, if you [use multiple databases](https://supportcenter.devexpress.com/ticket/details/e4896/how-to-connect-different-data-models-to-several-databases-within-a-single-application):
...
1. Compare the application name in the database with actual application name.  
    If they are not equal, the following error message appears: _Database is designed for the 'A' application while you are running the 'B' application._
