---
uid: DevExpress.ExpressApp.XafApplication.CreateCollectionSource(DevExpress.ExpressApp.IObjectSpace,System.Type,System.String,DevExpress.ExpressApp.CollectionSourceMode)
name: CreateCollectionSource(IObjectSpace, Type, String, CollectionSourceMode)
type: Method
summary: Creates a Collection Source for a specific [List View](xref:112611).
syntax:
  content: public CollectionSourceBase CreateCollectionSource(IObjectSpace objectSpace, Type objectType, string listViewId, CollectionSourceMode mode)
  parameters:
  - id: objectSpace
