---
uid: DevExpress.ExpressApp.XafApplication.CreateObjectSpace``1(System.String)
name: CreateObjectSpace<T>(String)
type: Method
...
syntax:
  content: public IObjectSpace CreateObjectSpace<T>(string tenantName)
  parameters:
  - id: tenantName
    type: System.String
