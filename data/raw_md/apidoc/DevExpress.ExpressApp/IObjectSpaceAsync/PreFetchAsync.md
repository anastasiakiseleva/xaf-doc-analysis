---
uid: DevExpress.ExpressApp.IObjectSpaceAsync.PreFetchAsync(System.Object,System.String[],System.Threading.CancellationToken)
...
syntax:
  content: Task PreFetchAsync(object collection, string[] propertyNames, CancellationToken cancellationToken = default(CancellationToken))
  parameters:
  - id: collection
    type: System.Object
  ...
  - id: propertyNames
    type: System.String[]
    description: An array of strings that are the names of the associated collection properties or delayed properties.
