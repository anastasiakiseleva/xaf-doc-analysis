---
uid: DevExpress.ExpressApp.IObjectSpaceAsync.GetObjectAsync(System.Object,System.Threading.CancellationToken)
name: GetObjectAsync(Object, CancellationToken)
type: Method
summary: Asynchronously retrieves an object from another Object Space to the current Object Space or gets a wrapped object (i.e., wrapped in [](xref:DevExpress.ExpressApp.IObjectRecord)).
syntax:
  content: Task<object> GetObjectAsync(object obj, CancellationToken cancellationToken = default(CancellationToken))
  parameters:
  - id: obj
    type: System.Object
