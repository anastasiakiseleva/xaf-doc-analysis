---
uid: DevExpress.ExpressApp.IObjectSpaceAsync.ToListAsync``1(System.Object,System.Threading.CancellationToken)
...
syntax:
  content: Task<List<T>> ToListAsync<T>(object collection, CancellationToken cancellationToken = default(CancellationToken))
  parameters:
  - id: collection
    type: System.Object
