---
uid: DevExpress.ExpressApp.IObjectSpaceAsync.FindObjectAsync``1(DevExpress.Data.Filtering.CriteriaOperator,System.Threading.CancellationToken)
...
syntax:
  content: Task<ObjectType> FindObjectAsync<ObjectType>(CriteriaOperator criteria, CancellationToken cancellationToken = default(CancellationToken))
  parameters:
  - id: criteria
