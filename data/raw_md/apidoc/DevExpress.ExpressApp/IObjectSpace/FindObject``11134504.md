---
uid: DevExpress.ExpressApp.IObjectSpace.FindObject``1(DevExpress.Data.Filtering.CriteriaOperator,System.Boolean)
name: FindObject<ObjectType>(CriteriaOperator, Boolean)
type: Method
summary: Searches for the first object that matches the specified criteria. The object's type is designated by the specified generic type parameter.
syntax:
  content: ObjectType FindObject<ObjectType>(CriteriaOperator criteria, bool inTransaction)
  parameters:
  - id: criteria
