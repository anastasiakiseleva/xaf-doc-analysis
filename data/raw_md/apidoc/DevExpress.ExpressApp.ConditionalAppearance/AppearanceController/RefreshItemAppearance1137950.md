...
syntax:
  content: public virtual void RefreshItemAppearance(IViewInfo view, string itemType, string itemName, object item, object[] contextObjects, EvaluatorContextDescriptor evaluatorContextDescriptor)
  parameters:
  - id: view
