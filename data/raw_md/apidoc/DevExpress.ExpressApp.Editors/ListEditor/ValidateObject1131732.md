---
uid: DevExpress.ExpressApp.Editors.ListEditor.ValidateObject
name: ValidateObject
type: Event
summary: Occurs when the object represented by the [](xref:DevExpress.ExpressApp.Editors.ListEditor)'s focused row must be validated.
syntax:
