---
uid: DevExpress.EasyTest.Framework.IEasyTestGridGrouping.ExpandGroup(System.String)
name: ExpandGroup(String)
type: Method
summary: Expands a specified group.
syntax:
  content: void ExpandGroup(string groupName)
  parameters:
  - id: groupName
    type: System.String
    description: The name of a group to expand.
seealso: []
---
Example:
