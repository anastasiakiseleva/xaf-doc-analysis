---
uid: DevExpress.EasyTest.Framework.IEasyTestGridEditing.InlineEdit(DevExpress.EasyTest.Framework.EasyTestParameter[])
name: InlineEdit(EasyTestParameter[])
type: Method
summary: Starts editing a specified row.
syntax:
  content: void InlineEdit(params EasyTestParameter[] parameters)
  parameters:
  - id: parameters
