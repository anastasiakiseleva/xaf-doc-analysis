---
uid: DevExpress.EasyTest.Framework.IEasyTestGridEditing.InlineCancel
name: InlineCancel()
type: Method
summary: Cancels the edit action of a row.
syntax:
  content: void InlineCancel()
seealso: []
---
Example:
...
namespace MainDemo.E2E.Tests {
    public class MainDemoTests : IDisposable {
        ...
        public void EditGridData(string applicationName) {
            ...
            appContext.GetGrid().InlineCancel();
            // ...
        }
    }
}
