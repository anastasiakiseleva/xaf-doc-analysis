---
uid: DevExpress.EasyTest.Framework.IEasyTestGridSelection.GetSelectedRowIndices
name: GetSelectedRowIndices()
type: Method
summary: Returns the array of selected rows' indexes.
syntax:
  content: int[] GetSelectedRowIndices()
  return:
    type: System.Int32[]
    description: An array of selected rows' indexes.
seealso: []
---
Example:
