---
uid: DevExpress.EasyTest.Framework.IEasyTestGridSelection.UnselectRows(System.String,System.String[])
name: UnselectRows(String, String[])
type: Method
summary: Unselects specified grid records.
syntax:
  content: void UnselectRows(string columnName, params string[] rowValues)
  parameters:
  - id: columnName
    type: System.String
  ...
  - id: rowValues
    type: System.String[]
    description: The specified column's values that identify unselected rows.
seealso: []
---
Example:
...
namespace MainDemo.E2E.Tests {
    public class MainDemoTests : IDisposable {
        ...
        public void EditGridData(string applicationName) {
            ...
            appContext.GetGrid().UnselectRows("Subject", "Task1");
            // ...
        }
    }
}
