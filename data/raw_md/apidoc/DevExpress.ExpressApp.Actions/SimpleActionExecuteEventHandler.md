---
uid: DevExpress.ExpressApp.Actions.SimpleActionExecuteEventHandler
name: SimpleActionExecuteEventHandler
type: Delegate
summary: Represents a method that will handle the [SimpleAction.Execute](xref:DevExpress.ExpressApp.Actions.SimpleAction.Execute) event.
syntax:
  content: public delegate void SimpleActionExecuteEventHandler(object sender, SimpleActionExecuteEventArgs e);
  parameters:
  - id: sender
    type: System.Object
    description: ''
