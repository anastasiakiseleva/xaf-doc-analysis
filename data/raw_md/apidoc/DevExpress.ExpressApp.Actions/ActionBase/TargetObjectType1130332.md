...
- linkId: "113103"
---
If an Action is contained in a View Controller, you can specify the kind of the type of object(s) for which the Action will be activated. For this purpose, use the **TargetObjectType** property. By default, this property is not set. You can set a value in the Controller's constructor. This value will be saved to the [Application Model](xref:112580)'s [](xref:DevExpress.ExpressApp.Model.IModelAction) node.
