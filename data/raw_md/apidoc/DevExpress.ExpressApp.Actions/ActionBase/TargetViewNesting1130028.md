...
- linkId: "113103"
---
If an Action is contained in a View Controller, you can specify the kind of a View for which the Action will be activated via the **TargetViewNesting** property. By default, this property is set to **Any**. You can set another value in the Controller's constructor or **Designer**. This value will be saved to the [Application Model](xref:112580)'s [!include[Node_Action](~/templates/node_action111373.md)] node.