---
uid: DevExpress.ExpressApp.Win.Editors.WinColumnsListEditor.GetSelectedObjects
name: GetSelectedObjects()
type: Method
summary: Provides access to the collection of objects that are currently selected in the [](xref:DevExpress.ExpressApp.Win.Editors.WinColumnsListEditor)'s grid.
syntax:
