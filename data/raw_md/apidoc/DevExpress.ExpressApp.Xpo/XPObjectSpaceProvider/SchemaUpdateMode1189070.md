---
uid: DevExpress.ExpressApp.Xpo.XPObjectSpaceProvider.SchemaUpdateMode
name: SchemaUpdateMode
type: Property
summary: Specifies how to handle compatibility checking for the database associated with the current @DevExpress.ExpressApp.Xpo.XPObjectSpaceProvider.
syntax:
  content: public SchemaUpdateMode SchemaUpdateMode { get; set; }
  parameters: []
  return:
