---
uid: DevExpress.ExpressApp.ApplicationBuilder.SecuredEFCoreObjectSpaceProviderBuilderExtensions.AddSecuredEFCore``1(DevExpress.ExpressApp.ApplicationBuilder.IObjectSpaceProviderServiceBasedBuilder{``0},System.Action{System.IServiceProvider,DevExpress.ExpressApp.ApplicationBuilder.EFCoreObjectSpaceProviderOptionsBuilder})
name: AddSecuredEFCore<TContext>(IObjectSpaceProviderServiceBasedBuilder<TContext>, Action<IServiceProvider, EFCoreObjectSpaceProviderOptionsBuilder>)
type: Method
...
syntax:
  content: |-
    public static DbContextServiceBasedBuilder<TContext> AddSecuredEFCore<TContext>(this IObjectSpaceProviderServiceBasedBuilder<TContext> builder, Action<IServiceProvider, EFCoreObjectSpaceProviderOptionsBuilder> configureObjectSpaceProviderOptions)
