---
uid: DevExpress.ExpressApp.ApplicationBuilder.IModuleBuilder`1.Add``1(System.Action{``0})
name: Add<TModule>(Action<TModule>)
type: Method
summary: Adds the specified [Module](xref:118046) to your application. Note that this Module must have the default constructor.
syntax:
  content: |-
    IModuleBuilder<TContext> Add<TModule>(Action<TModule> setupModule = null)
        where TModule : ModuleBase, new()
  parameters:
  - id: setupModule
    type: System.Action{{TModule}}
    defaultValue: "null"
    description: A delegate that configures the Module.
  typeParameters:
  - id: TModule
