---
uid: DevExpress.ExpressApp.ApplicationBuilder.EFCoreObjectSpaceProviderBuilderExtensions.AddEFCore``1(DevExpress.ExpressApp.ApplicationBuilder.IObjectSpaceProviderServiceBasedBuilder{``0},System.Action{DevExpress.ExpressApp.ApplicationBuilder.EFCoreObjectSpaceProviderOptionsBuilder})
name: AddEFCore<TContext>(IObjectSpaceProviderServiceBasedBuilder<TContext>, Action<EFCoreObjectSpaceProviderOptionsBuilder>)
type: Method
summary: Adds the @DevExpress.ExpressApp.EFCore.EFCoreObjectSpaceProvider`1 to your ASP.NET Core Blazor application.
syntax:
  content: |-
    public static DbContextServiceBasedBuilder<TContext> AddEFCore<TContext>(this IObjectSpaceProviderServiceBasedBuilder<TContext> builder, Action<EFCoreObjectSpaceProviderOptionsBuilder> configureObjectSpaceProviderOptions = null)
