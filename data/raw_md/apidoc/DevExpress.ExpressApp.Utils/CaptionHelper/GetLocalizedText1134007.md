---
uid: DevExpress.ExpressApp.Utils.CaptionHelper.GetLocalizedText(System.String,System.String)
name: GetLocalizedText(String, String)
type: Method
summary: Returns the value of a specified **LocalizationItem**.
syntax:
  content: public static string GetLocalizedText(string groupPath, string itemName)
  parameters:
  - id: groupPath
    type: System.String
