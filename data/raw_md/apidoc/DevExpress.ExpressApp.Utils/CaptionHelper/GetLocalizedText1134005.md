---
uid: DevExpress.ExpressApp.Utils.CaptionHelper.GetLocalizedText(System.String,System.String,System.Object[])
name: GetLocalizedText(String, String, Object[])
type: Method
summary: Returns the value of a specified **LocalizationItem**.
syntax:
  content: public static string GetLocalizedText(string groupPath, string itemName, params object[] args)
  parameters:
  - id: groupPath
    type: System.String
  ...
  - id: args
    type: System.Object[]
    description: An **Object[]** object array containing zero or more objects used to format the specified item's value.
  return:
    type: System.String
