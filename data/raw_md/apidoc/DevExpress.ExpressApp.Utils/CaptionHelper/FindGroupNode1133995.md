---
uid: DevExpress.ExpressApp.Utils.CaptionHelper.FindGroupNode(System.String)
name: FindGroupNode(String)
type: Method
summary: Provides access to the **LocalizationGroup** node corresponding to a specific group path.
syntax:
  content: public static IModelLocalizationGroup FindGroupNode(string groupPath)
  parameters:
  - id: groupPath
    type: System.String
...
Each child **LocalizationGroup** node of the **Localization** node has a group path associated with it. This path is represented by a sequence of parent localization group names separated by a double backslash. Suppose, for example, that the **Localization** node has the **Messages** localization group, which in turn has the **Custom** child localization group. In this case, the group path for the **Custom** group is "Messages\\Custom".
