---
uid: DevExpress.Persistent.BaseImpl.ModelDifferenceAspect.DisplayName
name: DisplayName
type: Property
summary: Gets the [language code](https://learn.microsoft.com/en-us/dotnet/api/system.globalization.cultureinfo) of the current [](xref:DevExpress.Persistent.BaseImpl.ModelDifferenceAspect) object, or the "(Default language)" text.
syntax:
