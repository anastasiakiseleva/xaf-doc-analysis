---
uid: DevExpress.Persistent.BaseImpl.EF.PermissionPolicy.PermissionPolicyUser.ChangePasswordOnFirstLogon
name: ChangePasswordOnFirstLogon
type: Property
summary: Specifies whether the user must change their password the on the next logon.
syntax:
  content: public virtual bool ChangePasswordOnFirstLogon { get; set; }
  parameters: []
  return:
    type: System.Boolean
