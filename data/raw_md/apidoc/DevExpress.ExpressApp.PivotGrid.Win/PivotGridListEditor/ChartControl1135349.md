---
uid: DevExpress.ExpressApp.PivotGrid.Win.PivotGridListEditor.ChartControl
name: ChartControl
type: Property
summary: Provides access to the [](xref:DevExpress.ExpressApp.PivotGrid.Win.PivotGridListEditor)'s charting control.
syntax:
  content: public ChartControl ChartControl { get; }
  parameters: []
  return:
    type: DevExpress.XtraCharts.ChartControl
    description: A [](xref:DevExpress.XtraCharts.ChartControl) object representing the current List Editor's charting control.
seealso: []
---
