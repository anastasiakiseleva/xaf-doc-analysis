---
uid: DevExpress.ExpressApp.Chart.Win.ChartListEditor.ChartControl
name: ChartControl
type: Property
summary: Provides access to the [](xref:DevExpress.ExpressApp.Chart.Win.ChartListEditor)'s control.
syntax:
  content: public ChartControl ChartControl { get; }
  parameters: []
  return:
    type: DevExpress.XtraCharts.ChartControl
    description: A [](xref:DevExpress.XtraCharts.ChartControl) object representing the current List Editor's control.
seealso: []
---
