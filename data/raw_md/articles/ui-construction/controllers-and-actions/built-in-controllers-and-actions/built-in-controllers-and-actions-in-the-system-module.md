...
This topic lists the built-in [Controllers](xref:112621) and their [Actions](xref:112622) supplied with the System's base, ASP.NET Core Blazor, and Windows Forms modules.
