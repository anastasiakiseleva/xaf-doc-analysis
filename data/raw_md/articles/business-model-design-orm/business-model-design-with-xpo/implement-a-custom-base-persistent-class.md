...
Public MustInherit Class BasePersistentObject  
    ...
    Protected Overrides Sub OnSaving()  
        ...
        UpdatedOn = Date.Now  
    End Sub  
    Private createdOn_Renamed As Date  
    <ModelDefault("AllowEdit", "False"), ModelDefault("DisplayFormat", "G")>  
    Public Property CreatedOn() As Date  
        Get  
            Return createdOn_Renamed  
        End Get  
        Set(ByVal value As Date)  
            SetPropertyValue("CreatedOn", createdOn_Renamed, value)  
        End Set  
    End Property  
    Private updatedOn_Renamed As Date  
    <ModelDefault("AllowEdit", "False"), ModelDefault("DisplayFormat", "G")>  
    Public Property UpdatedOn() As Date  
        Get  
            Return updatedOn_Renamed  
        End Get  
        Set(ByVal value As Date)  
            SetPropertyValue("UpdatedOn", updatedOn_Renamed, value)  
        End Set  
    End Property  
End Class
```
...
Public MustInherit Class BasePersistentObject
    ...
    <PersistentAlias(NameOf(_Oid)), Browsable(False)> _
